    ...
    return (<Container>
      ...
      <Content>
        <View horizotal="horizotal" grey="grey" p-16="p-16">
          <Text bold="bold" fs16="fs16">Payment</Text>
        </View>
        <View p-25="p-25" m-10="m-10" grey="grey">
          <Text fs16="fs16">Pay by card</Text>
        </View>
        <View p-25="p-25" m-10="m-10" grey="grey">
          <Text fs16="fs16">Cash on delivery</Text>
        </View>
      </Content>
      <Footer>
        <View m-r-10="m-r-10" center="center" center-h="center-h">
          <Button small="small" onPress={Actions.checkout_confirm}>
            <Text>NEXT</Text>
          </Button>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps({actions}))(CheckoutPaymentScreen)
