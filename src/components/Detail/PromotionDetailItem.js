...
const PromotionDetailItem = props => {
  ...
  return (
      <View horizontal style={{ height: size, width, marginTop: 10, marginRight: 10, marginLeft: 10, backgroundColor: 'white' }}>
        <View>
          <Image resizeMode='stretch' style={{width: size, height: size}} source={{uri: item.image?item.image:''}}/>
        </View>
        <View p-l-10>
