...
export function getPromotions() {
  return dispatch => {
    dispatch({type: constants.GET_PROMOTION_PENDING})
    HomeApi
      .getPromotions()
      .then((response) => {
        dispatch({type: constants.GET_PROMOTION_SUCCESS, payload: response.data.results})
      })
      .catch((error) => {
...
export function getNewshops() {
  return dispatch => {
    dispatch({type: constants.GET_NEWSHOP_PENDING})
    HomeApi
      .getNewshops()
      .then((response) => {
        dispatch({type: constants.GET_NEWSHOP_SUCCESS, payload: response.data.results})
      })
      .catch((error) => {
...
export function getCategories() {
  return dispatch => {
    dispatch({type: constants.GET_CAT_PENDING})
    HomeApi
      .getCategories()
      .then((response) => {
        dispatch({type: constants.GET_CAT_SUCCESS, payload: response.data.results})
      })
      .catch((error) => {
...
export function getHighRatingsShop() {
  return dispatch => {
    dispatch({type: constants.GET_HIGHRATINGSHOPS_PENDING})
    HomeApi
      .getHighRatingsShop()
      .then((response) => {
        dispatch({type: constants.GET_HIGHRATINGSHOPS_SUCCESS, payload: response.data.results})
      })
      .catch((error) => {
